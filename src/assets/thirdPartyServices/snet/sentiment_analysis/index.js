      ...
      <React.Fragment>
        ...
        <Grid item xs={12} style={{ textAlign: "left" }}>
          <OutlinedTextArea
            ...
            helperTxt={
              this.state.message.length + " / 5000 char " + " - " + this.handleSentences().length + " sentence(s)"
            }
            rows={5}
            charLimit={5000}
            ...
            htmlTooltip={
              <div>
                <p>
                  If you want to parse many sentences, divide the sentences by break lines and the service will respond
                  one analysis for each sentence.
                </p>
                <p>
                  In case you want analyze an entire sentence, please write your sentence continuously without line
                  break.
                </p>
              </div>
            }
        ...
        <OutlinedLabel
          ...
          htmlValue={
            <Grid container direction="row" justify="center" alignItems="center">
              <Grid item xs={5}>
                <span style={{ color: "#212121" }}>Sentence</span>
              </Grid>
              <Grid item xs={2}>
                <span style={{ color: "#212121" }}>Sentiment</span>
              </Grid>
              <Grid item xs={5}>
                <Tooltip
                  style={{ width: "200px" }}
                  title={
                    <Typography>
                      ...
                      <br />
                      <span>
                        The <b>compound</b> score is computed by summing the valence scores of each word in the lexicon,
                        ...
                        unidimensional measure of sentiment for a given sentence. Calling it a 'normalized, weighted
                        composite score' is accurate.
                      </span>
                      <br />
                      <br />
                      <span>
                        The <b>pos</b>, <b>neu</b>, and <b>neg</b> scores are ratios for proportions of text that fall
                        in each category (so these should all add up to be 1... or close to it with float operation).
                        These are the most useful metrics if you want multidimensional measures of sentiment for a given
                        sentence.
                      </span>
                      <br />
                      <br />
                    ...
                    <Grid container direction="row" justify="center" alignItems="center">
                      ...
                      <Grid item xs={2}>
                        <span style={{ color: "#666" }}>
                          {sentiment === "Positive" ? (
                            <span>
                              <PositiveIcon style={{ verticalAlign: "middle" }} />
                            </span>
                          ) : null}
                          {sentiment === "Neutral" ? (
                            <span>
                              <NeutralIcon style={{ verticalAlign: "middle" }} />
                            </span>
                          ) : null}
                          {sentiment === "Negative" ? (
                            <span>
                              <NegativeIcon style={{ verticalAlign: "middle" }} />
                            </span>
                          ) : null}
                          <span> {sentiment}</span>
                        </span>
                      ...
                      <Grid item xs={5}>
                        <span
                          style={{ color: "#666" }}
                        >{`pos: ${item.analysis.pos}, neu: ${item.analysis.neu}, neg: ${item.analysis.neg}, compound: ${item.analysis.compound}`}</span>
                      </Grid>
                    </Grid>
                  </Grid>
                );
