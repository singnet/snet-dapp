...
function styledDropdownWrap(name, list, value, onchange, class_name) {
  return (
    <div className="row">
      <div style={htstyle}>{name}</div>
      <div className={class_name}>
        <StyledDropdown list={list} value={value} onChange={onchange} />
      </div>
    </div>
  );
}
...
class MatchingService extends React.Component {
    ...
    if (this.state.methodName !== "Select a method") {
      if (this.state.methodName === "getKP") {
        ...
        return (
          ...
          this.state.detector_name !== "Select a value" &&
        ...
        return (
          ...
          this.state.detector_name !== "Select a value" &&
          this.state.descriptor_name !== "Select a value" &&
          this.state.transform_name !== "Select a value"
        );
  ...
  chooseRender(classes) {
    if (this.state.methodName === "getMatchByImage") {
      return this.renderForm_getmatch();
    } else if (this.state.methodName === "getTransformParametersByImage") {
      return this.renderForm_gettransform(classes);
    } else if (this.state.methodName === "getClosestImages") {
      return this.renderForm_getclosest(classes);
    }
  }
  ...
  renderForm_getmatch() {
    ...
    return (
      <React.Fragment>
        {styledDropdownWrap(
          "Descriptor Name:",
          descriptorMethodsList,
          this.state.descriptor_name,
          this.handleDescriptorChange,
          classes.dropDown
        )}
  ...
  renderForm_getclosest(classes) {
    return (
      <div>
        ...
        <div align="center">
          <div style={htstyle}>Choose database (upload a folder with images):</div>
  ...
  renderForm() {
    ...
    return (
      <React.Fragment>
        <div className="row">
          <div style={htstyle}>Method Name: </div>
          <div>
            <MethodNamesDropDown
