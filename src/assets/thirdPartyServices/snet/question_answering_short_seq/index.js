...
export default class ShortQuestionAnswering extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      code_repo: "https://github.com/iktina/question-answering-short-seq-service",
      reference: "https://github.com/iktina/question-answering-short-seq-service",
      response: undefined,
    };
  }
  ...
  submitAction() {
    ...
    const methodDescriptor = QABERT["qa_bert"];
