            ...
            <Table>
              <TableBody>
                <TableRow>
                  ...
                  <TableCell align="left">
                    <Typography variant="subtitle1">{res.call.result.algorithms[1].return.binary_classification_result}</Typography>
                  </TableCell>
                </TableRow>
              </TableBody>
            </Table>
            ...
            <Table>
              <TableBody>
                ...
                <TableRow>
                  ...
                  <TableCell align="left">
                    <Typography variant="subtitle1">{res.call.result.algorithms[0].return.disagree.toFixed(2)}</Typography>
                  </TableCell>
                </TableRow>
                <TableRow>
                  <TableCell align="right">
                  ...
                  <TableCell align="left">
                    <Typography variant="subtitle1">{res.call.result.algorithms[0].return.discuss.toFixed(2)}</Typography>
                  </TableCell>
                </TableRow>
                <TableRow>
                  <TableCell align="right">
                  ...
                  <TableCell align="left">
                    <Typography variant="subtitle1">{res.call.result.algorithms[0].return.unrelated.toFixed(2)}</Typography>
                  </TableCell>
                </TableRow>
              </TableBody>
            </Table>
