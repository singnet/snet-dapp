      ...
      <Grid container className={classes.headerContentDetails}>
        ...
        <Grid item xs={6} sm={7} md={7} lg={7} className={classes.details}>
          ...
          <p>
            ...
            as separate audio files. The app leverages the AI service of Deezer Spleeter which is available for demo and
            integration.<span>The android app is available on Google Play Store now. </span>
          </p>
