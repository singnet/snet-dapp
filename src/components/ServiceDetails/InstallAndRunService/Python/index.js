  ...
  return (
    <section className={classes.languageTabSection}>
      ...
      <div className={classes.setingUpFilesContainer}>
        ...
        <div>
          <span>Create and activate virtual environment</span>
          <CodeSnippet>
            # For unix/macOS:
            <br />
        ...
        <div>
          ...
          <CodeSnippet>
            1. update <b>&#60;your wallet's private key&#62;</b> with your wallet's private key
            <br />
        ...
        <div>
          ...
          <CodeSnippet>
            1. update <b>service_stub</b> with your service stub from &#60;stub&#62;_pb2_grpc.py file
            <br />
            2. update <b>input_method</b> with your service's input method
            <br />
            3. update <b>arguments</b> with your service's arguments
            <br />
            4. update <b>service_method</b> with your service's output method
            <br />
            <br />
