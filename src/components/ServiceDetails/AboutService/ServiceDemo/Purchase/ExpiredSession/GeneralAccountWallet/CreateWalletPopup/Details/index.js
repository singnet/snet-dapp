...
const Details = ({ classes }) => {
  return (
  	<div className={classes.deatilsTabContainer}>
  		...
  		<Typography variant="body1" className={classes.deatilsTabDesc} >Information about the Payment type and Amount. Lorem ipsum dolor sita am et, at euismod tincidunt per. Vix case discere ne, ea erant singulis vels. Nibhas aliquip prompta quo ex, hinc nobis no his.</Typography>
  		...
  		<div className={classes.providerAndBalanceInfo}>
  			<div className={classes.providerDetails}>
  				...
  				<div>
	  				<Typography variant="body2" className={classes.providerName}>Service Provider 1</Typography>
	  				<Typography variant="body2" className={classes.noOfService}>3 AI Services</Typography>
	  			</div>
  			</div>
