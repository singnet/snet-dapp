...
const Purchase = ({ classes, error }) => {
	...
	return (
		<div className={classes.purchaseContainer}>
  		...
  		<Typography variant="body1" className={classes.purchaseDesc}>Please wait while your transaction is being recorded into the block chain. The execution will proceed once its done. 
			Please don’t close or refresh the window.</Typography>
  	</div>
	)
