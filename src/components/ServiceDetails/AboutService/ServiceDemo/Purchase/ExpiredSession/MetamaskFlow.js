...
const connectMMinfo = {
  ...
  message: `Please install Metamask and use your Metamask wallet to connect to SingularityNet. 	  message: `Please Login or Install to your Metamask wallet account and connect to SingularityNet. 
