...
//   const { currentModel } = useSelector((state) => state.serviceDetailsReducer.detailsTraining);
...
//   const AddressList = () => {
//     if (currentModel?.address?.length) {
//       return currentModel?.address.map((address) => <li key={address}>{addEllipsisAtEndOfString(address)}</li>);
//     }
//     return null;
//   };
...
//       channelInfo
//     );
//     const descriptor = currentModel.method.split(".")[1].split("/")[1];
//     const methodDescriptor = Calculator[descriptor];
//     const request = new methodDescriptor.requestType();
//     request.setLink(currentModel.dataLink);
//     request.setAddress(wallet.address);
//     request.setModelId(currentModel.modelId);
...
//           </Grid>
//           <Grid item xs={9}>
//             <Typography>{currentModel?.description || ""}</Typography>
//           </Grid>
//         </Grid>
//         <Grid container>
//           <Grid item xs={3}>
...
//           </Grid>
//           <Grid item xs={9}>
//             <Typography>{currentModel?.dataLink || ""}</Typography>
//           </Grid>
//         </Grid>
//         <Grid container>
//           <Grid item xs={3}>
...
//       </div>
//       {!purchaseCompleted ? (
//         <PaymentMode currentModel={currentModel} handlePurchaseComplete={handlePurchaseComplete} />
//       ) : null}
