      ...
      <body>
        ...
        <p>
          <span>
            ...
            If these terms and conditions are considered an offer by SingularityNET, acceptance is expressly limited to
        ...
        <p>
          <span>
            ...
            regardless of whether the Content in question constitutes text, graphics, an audio file, or computer
        ...
        <p>
          ...
          <span>
            ...
            objectionable, or (ii) terminate or deny access to and use of the Website to any individual or entity for
            any reason, in SingularityNET&rsquo;s sole discretion. SingularityNET will have no obligation to provide a
        ...
        <p>
          <span>
            ...
            of that service or upgrade for a monthly or annual subscription period as indicated. These fees are not
            refundable.
          </span>
        </p>
        ...
        <p>
          <span>
            ...
            horses, and other harmful or destructive content. The Website may contain content that is offensive,
            indecent, or otherwise objectionable, as well as content containing technical inaccuracies, typographical
            mistakes, and other errors. The Website may also contain material that violates the privacy or publicity
            rights or infringes the intellectual property and other proprietary rights, of third parties, or the
            downloading, copying or use of which is subject to additional terms and conditions, stated or unstated.
            SingularityNET disclaims any responsibility for any harm resulting from the use by visitors of the Website,
        ...
        <p>
          ...
          <span>
            ...
            property rights of SingularityNET or others. In the case of such termination, SingularityNET will have no
        ...
        <p>
          <span>
            ...
            changes. SingularityNET may also, in the future, offer new services and/or features through the Website
        ...
        <p>
          <span>
            ...
            or services; (iii) for interruption of use or loss or corruption of data; or (iv) for any amounts that
            exceed the fees paid by you to SingularityNET under this agreement during the twelve (12) month period prior
            to the cause of action. SingularityNET shall have no liability for any failure or delay due to matters
        ...
        <p>
          ...
          <span>
            ...
            from the country in which this website resides or the country in which you reside) and (ii) your use of the
        ...
        <p>
          <span>
            ...
            law, if any, provides otherwise, this Agreement, any access to or use of the Website will be governed by the
            laws of the state of California, U.S.A., excluding its conflict of law provisions, and the proper venue for
            any disputes arising out of or relating to any of the same will be the state and federal courts located in
            San Francisco County, California. Except for claims for injunctive or equitable relief or claims regarding
            ...
            Arbitration Rules of the Judicial Arbitration and Mediation Service, Inc. (&ldquo;JAMS&rdquo;) by three
            arbitrators appointed in accordance with such Rules. The arbitration shall take place in San Francisco,
            California, in the English language and the arbitral decision may be enforced in any court. The prevailing
            party in any action or proceeding to enforce this Agreement shall be entitled to costs and attorneys&rsquo;
            fees. If any part of this Agreement is held invalid or unenforceable, that part will be construed to reflect
            the parties&rsquo; original intent, and the remaining portions will remain in full force and effect. A
            ...
            SingularityNET may assign its rights under this Agreement without condition. This Agreement will be binding
            upon and will inure to the benefit of the parties, their successors and permitted assigns.&rsquo;
          </span>
        </p>
      </body>
    </html>
