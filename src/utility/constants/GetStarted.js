...
export const GetStartedCategoriesData = [
  {
    ...
    categoryTabs: [
      { title: "AI Services list", media: { type: "gif", content: "" } },
  ...
  },
  {
    ...
    categoryTabs: [
      { title: "AI Service Details", media: { type: "video", content: "" } },
  ...
  },
  {
    ...
    categoryTabs: [
      { title: "Provide feedback", media: { type: "img", content: "" } },
  ...
  },
  {
    ...
    categoryTabs: [
      { title: "Payment", media: { type: "video", content: "content" } },
  ...
  },
  {
    ...
    categoryTabs: [
      { title: "Using the SDK", media: { type: "video", content: "content" } },
      /*{ title: "Change Filter options", media: { type: "gif", content: "content" } },
      { title: "Sort options", media: { type: "gif", content: "content" } },
      { title: "Rating Ranking", media: { type: "gif", content: "content" } },
      { title: "Feature Label 5", media: { type: "gif", content: "content" } },*/
