...
class MPEContract {
  ...
  async openChannel(account, service, amountInCogs, expiry) {
    ...
    const { payment_address: recipientAddress, group_id_in_bytes: groupId } = service.group;
  ...
  async depositAndOpenChannel(account, service, amountInCogs, expiry) {
    ...
    logger.info(`Depositing ${amount}cogs to MPE address and Opening new payment channel [expiry: ${expiryStr}]`, {
      tags: ['MPE'],
    });
