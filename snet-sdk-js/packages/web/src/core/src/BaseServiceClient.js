...
class BaseServiceClient {
  ...
  async _trainingStateRequest(params) {
    ...
    const { currentBlockNumber, signatureBytes } = await this._requestSignForModel(params.address, message);
  ...
  _getModelRequestMethodDescriptor() {
    logger.error("_getModelRequestMethodDescriptor must be implemented in the sub classes");
  }
  ...
  _getUpdateModelRequestMethodDescriptor() {
    logger.error("__getUpdateModelRequestMethodDescriptor must be implemented in the sub classes");
  }

  _getModelDetailsRequestMethodDescriptor() {
    logger.error("_getModelDetailsRequestMethodDescriptor must be implemented in the sub classes");
  }
